<x-app-layout>
    ...
    <div class="flex  flex-col justify-center items-center mt-10">
        ...
        <div class="w-[35rem] border border-gray-400 rounded-md p-10 flex flex-col gap-5">
            ...
            <form id="user-form" class="flex flex-col gap-5" method="post" action="javascript:void(0)"
                ...
                <div>
                    ...
                    <x-file-input id="image" type="text" name="image" :value="old('image')" />
